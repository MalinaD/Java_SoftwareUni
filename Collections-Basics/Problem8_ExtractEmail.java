...
//the first input line. Print the emails in the output, each at a separate line. Emails are 
...
public class Problem8_ExtractEmail {
	...
	public static void main(String[] args) {
		...
		Pattern pattern = Pattern.compile("\\b[\\w-+]+(?:\\.[\\w-+]+)*@(?:[\\w-]+\\.)+[A-Za-z]{2,7}\\b");
